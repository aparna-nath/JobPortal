        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li class="d-lg-none"><a href="/employerLogin"><span class="mr-2">+</span> Employer</a></li>
              <li class="d-lg-none"><a href="/userLogin">User Log In</a></li>
            </ul>
          </nav>
          
          <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
            <div class="ml-auto">
              <a href="/employerLogin" class="btn btn-primary border-width-2 d-none d-lg-inline-block"><span class="mr-2 icon-add"> 
               </span>Employer</a>
              <a href="/userLogin" class="btn btn-primary border-width-2 d-none d-lg-inline-block"><span class="mr-2 icon-lock_outline"></span>User Log In</a>
            </div>
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center">
              ...
              <p>Search hundreds of jobs posted, Register with us! <a href="/userRegister" class="btn btn-primary btn-md text-white">Signup here</a></p>
            </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-3 ml-auto">
            <a href="/userRegister" class="btn btn-warning btn-block btn-lg">Sign Up</a>
          </div>
        </div>
      </div>
    </section>
