    ...
    <header class="site-navbar mt-3">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="site-logo col-6"><a href="/employerHome">JobPortal</a></div>

          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              <li><a href="/employerHome" class="nav-link active">Home</a></li>
              ...
              <li class="has-children">
                ...
                <ul class="dropdown">
                  <li><a href="/employerPostjob">Post a Job</a></li>
                  <li><a href="/employerJoblist">View Applicants</a></li>
                </ul>
              </li>
              <li class="d-lg-none"><a href=""><span class="mr-2">+</span> Empolyer</a></li>
          ...
          <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
            <div class="ml-auto">
              <a href="/Logout" class="btn btn-primary border-width-2 d-none d-lg-inline-block"><span class="mr-2 icon-lock_outline"></span>Logout</a>
            </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            ...
            @endif
              <h1 class="text-white font-weight-bold">Find the talents best for your company</h1>
              <p>You can choose from hundrends of our users</p>
              <a href="/employerJoblist" class="btn btn-primary border-width-2 d-none d-lg-inline-block">Find the talents here</a>
            </div>
